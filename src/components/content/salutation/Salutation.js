        ...
        <div id="Salutation" className="container-gap pt-5 d-flex">
            <div className={ `d-flex m-auto flex-${isMobile? 'column' : 'row'}` }>
                ...
                <div style={{
                    ...
                    <span className="regular-text mt-3 me-auto">
                        Форум – это площадка для обмена опытом внедрения и использования цифровой
                        трансформации на предприятиях региона с помощью  современных инновационных подходов и
                        сквозных информационных технологий (BigData, AI, CV, IoT и других)
                    </span>
                </div>
            </div>
        </div>
